...
- 当前机器事实源：[.agent_board/CURRENT_FACTS.json](/A:/codex-memory/.agent_board/CURRENT_FACTS.json)
...
当前 Git / PR / review / validation 的完整事实以 `.agent_board/CURRENT_FACTS.json` 为准。Markdown 状态面只保留 active block 摘要和历史归档入口，不重复完整当前 commit hash。
