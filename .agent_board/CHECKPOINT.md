...
- Thirty-three focused R4 tests cover claim/ack, request and lease expiry, reconnect/reclaim, replay, in-flight cancellation, response correlation, loopback normalization, split UTF-8 preservation, non-loopback rejection, and body-log absence.
- Final default validation passed `5759` with `8` documented skips; hardening passed `97/97 + 6/6`.
