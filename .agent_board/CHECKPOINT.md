...
- Local branch is ahead of `origin/main` by CM-0307 `408a92c`, CM-0308 `d1f48c2`, and CM-0309 `cb7d1ef`.
...
Create a guarded local CM-0310 commit if staged diff remains scoped. Push remains user-directed and not authorized. Next safe task after CM-0310 is P39 Synthetic Migration Dry-run Contract, still synthetic fixture or sanitized metadata only.
