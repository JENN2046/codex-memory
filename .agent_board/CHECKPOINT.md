...
P2 badge correction:
- CM-1195 supersedes CM-1194's reviewed-object binding. Latest review feedback says the reviewed CM-1185 status-sync checkout commit is short object `3a5a5d88`, with parent short object `1abb5a37`; CM-1194's `aa78ee6742e556de7b96b84e26949949364776a3`, CM-1193's `1f4705352f8b8d574ddcce44c52cd2c3458a14af`, and CM-1192's `9eb258d8e83504646dba1175c44fc54c20ee9799` must not be used as the reviewed-context sync commit.
- Current local/GitHub PR #6 facts before this local fix are `HEAD == origin/hardening/p0-p2-security-rc-base == PR #6 head == cc2f23c9aa22a528858008b3057507c9568bdd0a`. Local `git show`, GitHub commits API, and `git ls-remote` cannot resolve `3a5a5d88` or `aa78ee67`; later operators must treat `3a5a5d88` as review-checkout evidence only and keep it separate from current Git/PR head before push-readiness or CI decisions.
