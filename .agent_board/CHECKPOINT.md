...
P2 badge correction:
- CM-1199 supersedes CM-1198's unknown reviewed-object posture. Latest review feedback says the reviewed CM-1185 status-sync applied commit is `f1965a3fcd985fb9a1dfb69aeed3d118f492907d`, with parent `1abb5a3785af5ac96684fe3d7728eb7027e41a98`; CM-1198's `UNKNOWN_UNRESOLVABLE_REVIEW_OBJECT`, CM-1197's `980c5cb7b2c4e27b3d85d4f0fbbf22e20617f890`, CM-1196's `01774406e93959a00d70d0d38dc408dac5c81bb4`, CM-1195's `3a5a5d88`, CM-1194's `aa78ee6742e556de7b96b84e26949949364776a3`, CM-1193's `1f4705352f8b8d574ddcce44c52cd2c3458a14af`, and CM-1192's `9eb258d8e83504646dba1175c44fc54c20ee9799` must not be used as the reviewed-context sync commit.
- Current local/GitHub PR #6 facts before this local fix are `HEAD == origin/hardening/p0-p2-security-rc-base == PR #6 head == 13cefdc0bcc83985f753ae036d2e9161589b9199`, with CI `Node.js tests` passed. Local `git show`, GitHub commits API, and `git ls-remote` cannot resolve `f1965a3fcd985fb9a1dfb69aeed3d118f492907d`. Later operators must treat `f1965a3fcd985fb9a1dfb69aeed3d118f492907d` as review feedback evidence and keep it separate from current Git/PR head before push-readiness or CI decisions.
