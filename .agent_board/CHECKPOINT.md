...
P2 badge correction:
- CM-1194 supersedes CM-1193's reviewed-object binding. User-provided fresh review evidence says the reviewed CM-1185 status-sync commit is `aa78ee6742e556de7b96b84e26949949364776a3`, with parent `1abb5a3785af5ac96684fe3d7728eb7027e41a98`; CM-1193's `1f4705352f8b8d574ddcce44c52cd2c3458a14af` and CM-1192's `9eb258d8e83504646dba1175c44fc54c20ee9799` must not be used as the reviewed-context sync commit.
- Current local/GitHub PR #6 facts before this local fix are `HEAD == origin/hardening/p0-p2-security-rc-base == PR #6 head == 133c681cd49a7d2685774391951a34550c7d407a`; CM-1192's `7cdcc0e40da5c6439654660690634c3f5e3dbf99` current-head fact is stale. `aa78ee6742e556de7b96b84e26949949364776a3` and `1f4705352f8b8d574ddcce44c52cd2c3458a14af` are not present in this local checkout; later operators must keep reviewed-object evidence separate from the current Git/PR head before push-readiness or CI decisions.
