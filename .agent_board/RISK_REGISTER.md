...
| RR-0005 | monitoring | P0-mainline-health / write-reconcile | Internal reconcile service/worker surfaces may be misread as automatic degraded recovery or broad write reliability | Future work could overclaim readiness or start queue processing through startup/watchdog/config without runtime evidence | Treat CM-1035 as internal manual replay service, CM-1036 through CM-1041 as internal default-disabled / explicit temp-local worker evidence only, CM-1042 as bounded HTTP health status only, and CM-1043 as bounded HTTP observe status only; require separate runtime-refresh evidence, startup/config approval, and long-running safety review before any automatic recovery, startup execution, or reliability claim | commander | 2026-05-25 |
