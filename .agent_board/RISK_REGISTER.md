...
| RR-0005 | monitoring | P0-mainline-health / write-reconcile | Internal reconcile service/worker surfaces may be misread as automatic degraded recovery or broad write reliability | Future work could overclaim readiness or start queue processing through startup/watchdog/config without runtime evidence | Treat CM-1035 as internal manual replay service and CM-1036 as an internal default-disabled worker candidate only; require separate runtime evidence, startup/config approval, and long-running safety review before any automatic recovery, startup execution, or reliability claim | commander | 2026-05-25 |
