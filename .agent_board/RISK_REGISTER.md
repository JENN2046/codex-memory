...
| RR-0005 | monitoring | P0-mainline-health / write-reconcile | Internal default-idle reconcile replay service may be misread as automatic degraded recovery or broad write reliability | Future work could overclaim readiness or start queue processing without a worker design gate | Treat CM-1035 as internal manual replay surface only; require separate worker design/review and runtime evidence before any automatic recovery, startup execution, or reliability claim | commander | 2026-05-25 |
