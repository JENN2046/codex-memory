...
Current task: `CM-1872 exact live runtime approval request field gap preflight`.
Current validation: `CMV-1975`.
Current handoff: CM-1872 inventories missing exact fields and authorities as classifications only. Approval packet/request/request body/approval line, runtime, memory read/write, release/deploy/cutover/push, and readiness are not opened.
