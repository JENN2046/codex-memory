...
Current handoff: CM-1873 adds a source/test fixture contract for missing exact field gap classifications only. Approval packet/request/request body/approval line, runtime, memory read/write, release/deploy/cutover/push, and readiness are not opened.
