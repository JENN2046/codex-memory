...
Current handoff: CM-1866 defines a non-authorizing exact live runtime approval boundary preflight. Future request-packet skeleton preparation is allowed, but approval packet/request/request body/approval line, runtime, memory read/write, release/deploy/cutover/push, and readiness are not opened.
