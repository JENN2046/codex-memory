...
- Synthetic proof: actual loopback HTTP and temporary UDS, 34 focused tests including asynchronous completion-state, normalized-root, and split-UTF-8 regressions, all provider/native/fallback/write/durable/global-search counters zero.
