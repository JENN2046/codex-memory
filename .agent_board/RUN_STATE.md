...
- Synthetic proof: actual loopback HTTP and temporary UDS, 33 focused tests including normalized-root and split-UTF-8 regressions, all provider/native/fallback/write/durable/global-search counters zero.
