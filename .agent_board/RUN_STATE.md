...
- Synthetic proof: actual loopback HTTP and temporary UDS, 35 focused tests including asynchronous completion-state, Edge-timeout alignment, normalized-root, and split-UTF-8 regressions, all provider/native/fallback/write/durable/global-search counters zero.
