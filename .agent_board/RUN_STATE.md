...
| Git repository | yes |
| Branch | main |
| Local HEAD at CM-0715 start | `2f6a76d feat: expose governance next action` |
| Remote baseline | `origin/main = 4997db5 feat: add local autopilot control loop surfaces` |
| Worktree at CM-0715 start | `main...origin/main [ahead 12]`; tracked worktree was clean before this dashboard recall scope evidence-state slice. |
| Mode | Smart Standing Authorization v3 - Budgeted Autonomy Envelope |
| A4.8 role | legacy local-safe rail and Green Lane substrate |
| Current task | CM-0715 dashboard recall scope evidence state; preserve `NOT_READY_BLOCKED / RC_NOT_READY_BLOCKED`. |
...
| Last action | Added read-only dashboard recall scope evidence fields plus text `RecallScope` so the client-scope recall gap is machine-readable and operator-visible. |
...
| Safe-push readiness | Not evaluated for CM-0704/CM-0705/CM-0706/CM-0707/CM-0708/CM-0709/CM-0710/CM-0711/CM-0712/CM-0713/CM-0714/CM-0715; push still requires explicit user authorization or a separately passing safe-push packet. |
| Next planned action | Complete docs validation/diff check, create a guarded local commit for CM-0715 if clean, then continue local-safe scope/governance hardening or wait for explicit push authorization. |
