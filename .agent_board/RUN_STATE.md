...
- Synthetic proof: actual loopback HTTP and temporary UDS, 36 focused tests including expired-record capacity reclamation, asynchronous completion-state, Edge-timeout alignment, normalized-root, and split-UTF-8 regressions, all provider/native/fallback/write/durable/global-search counters zero.
