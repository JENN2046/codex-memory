...
| Current task | CM-1294 recall audit scope field fallback normalization validated |
...
| Runtime/source touched by current task | `src/recall/RecallAuditService.js`; recall audit scope metadata now accepts camel/snake-case aliases while preserving raw workspace redaction |
