...
Next safe action is CM-1829 M9 exact request field candidate fixture contract. It should turn the CM-1828 candidate matrix into a pure local source/test contract, while preserving that request submission, approval-line generation, runtime execution, real proposal generation/submission, accepted real proposal receipts, memory read/write, provider/API, public MCP expansion, M10/M15 unlock, and readiness remain blocked. Push remains separate explicit authorization.
