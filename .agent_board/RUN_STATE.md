...
| Current task | CM-1278 lifecycle scope fallback normalization validated |
...
| Runtime/source touched by current task | `src/core/MemoryLifecycleScopeGovernanceContract.js`; lifecycle governance scope now uses first non-empty normalized camel/snake value |
