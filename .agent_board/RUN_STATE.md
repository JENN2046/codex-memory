...
| Current task | CM-1300 proof-memory policy alias fallback validated |
...
| Runtime/source touched by current task | `src/core/ProofMemoryPolicy.js`; proof-memory write policy now normalizes visibility/retention aliases before proof-memory classification |
