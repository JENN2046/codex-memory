...
- Synthetic proof: actual loopback HTTP and temporary UDS, 37 focused tests including expired-record capacity reclamation, asynchronous completion-state, Edge-timeout alignment, normalized-root, split-UTF-8, open-peer frame, and listener-alias regressions, all provider/native/fallback/write/durable/global-search counters zero.
