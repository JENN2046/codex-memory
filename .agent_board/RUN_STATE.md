...
| Current task | CM-1281 write lifecycle preflight fallback normalization validated |
...
| Runtime/source touched by current task | `src/core/MemoryWriteLifecycleDedupSuppressionPreflight.js`; write preflight scope/lifecycle/candidate fields now use first non-empty normalized camel/snake value |
