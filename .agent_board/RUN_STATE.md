...
| Git repository | yes |
| Branch | main |
| Local HEAD at CM-0709 start | `e3a3e74 fix: normalize autopilot coverage parsing` |
| Remote baseline | `origin/main = 4997db5 feat: add local autopilot control loop surfaces` |
| Worktree at CM-0709 start | `main...origin/main [ahead 6]`; tracked worktree was clean before this dashboard operational health split slice. |
| Mode | Smart Standing Authorization v3 - Budgeted Autonomy Envelope |
| A4.8 role | legacy local-safe rail and Green Lane substrate |
| Current task | CM-0709 dashboard operational health split; preserve `NOT_READY_BLOCKED / RC_NOT_READY_BLOCKED`. |
...
| Last action | Completed guarded local commit `e3a3e74 fix: normalize autopilot coverage parsing`, then started CM-0709 to split dashboard operational health from governance/readiness warnings. |
...
| Safe-push readiness | Not evaluated for CM-0704/CM-0705/CM-0706/CM-0707/CM-0708/CM-0709; push still requires explicit user authorization or a separately passing safe-push packet. |
