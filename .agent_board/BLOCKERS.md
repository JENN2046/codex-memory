...
| CMB-0014 | open | dirty-worktree-write-proof-baseline | P0-mainline-health / P8-memory-governance | CM-0907 / CM-0908 future write proof execution | CM-0907 binds an explicit `CM-0737` write proof execution preflight and CM-0908 can collect current local Git facts, but repository reality remains dirty, so it cannot be treated as clean executable write proof baseline evidence | Re-run fresh Git/runtime preflight and bind clean current branch/head/worktree facts before any future live write proof; use CM-0908 current-facts CLI and CM-0907 fixture CLI as preflight review only; fail closed if dirty, stale, ambiguous, source-drifted, or missing exact basis/seam/scope/boundary input | 2026-05-24 |
