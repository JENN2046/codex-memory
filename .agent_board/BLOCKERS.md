...
| CMB-0015 | open | recall-negative-control-proof-failure | P0-mainline-health / P2-active-memory | CM-1012 CM0825 recall proof attempt | A clean-head CM0825 proof attempt at `c6926505603240d10bb8a1caa4903fa061c49ce7` returned Q4 `stricter_negative_control` resultCount `3` despite zero side-effect counters and sanitized output only. The runner wiring guard is now patched, but no post-fix clean-head live proof has executed. | Commit the guard after validation; before any future recall proof, return to a clean synced baseline, rerun current-facts preflight, and preserve no-readiness/no-reliability wording. | 2026-05-25 |
