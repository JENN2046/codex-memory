...
| CMB-0027 | open-f4-exact-approval-required | Phase-F4-minimal-personal-dogfood-write-approval-missing | P9-codex-claude-client-scope / P8-memory-governance / P0-mainline-health | CM-1381 Phase F3 true-live recall negative-control evidence | F1/F2/F3 evidence are accepted, but F4 minimal personal dogfood write has not been approved or executed for the current evidence chain. | Obtain separate exact F4 one-write approval after CM-1381 is committed/synced. Do not proceed to F5 until F4 evidence is accepted. No provider, broad real memory scan, config/watchdog/startup change, remote action, readiness claim, or reliability claim without explicit scope. | 2026-06-02 |
