...
| CMB-0003 | open | model-api-connectivity | P9-codex-claude-client-scope | CM-0025 | `deepseek-v4-pro` model-mediated tool call failed before MCP tool execution with API `ConnectionRefused` | Restore/fix model provider connectivity, then rerun the `deepseek-v4-pro` `memory_overview` acceptance command | 2026-05-06 |
