...
| CMB-0026 | open-f3-exact-approval-required | Phase-F3-true-live-recall-negative-control-approval-missing | P9-codex-claude-client-scope / P8-memory-governance / P0-mainline-health | CM-1379 Phase F2 A5-GAP-6 aggregation evidence | F1 and F2 evidence are accepted, but F3 true-live recall negative-control proof has not been approved or executed for the current evidence chain. | Obtain separate exact F3 true-live recall negative-control approval on a fresh synced commit. Do not proceed to F4/F5 until F3 evidence is accepted. No provider, durable write, config/watchdog/startup change, broad real memory scan, remote action, readiness claim, or reliability claim without explicit scope. | 2026-06-02 |
