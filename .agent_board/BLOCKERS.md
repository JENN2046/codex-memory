...
| CMB-0014 | open | dirty-worktree-write-proof-baseline | P0-mainline-health / P8-memory-governance | CM-0907 / CM-0908 / CM-1009 / CM-1010 future write proof execution | CM-0907 binds an explicit `CM-0737` write proof execution preflight, CM-0908 can collect current local Git facts, CM-1009 marks preflight as preflight-only/no implicit write authorization, and CM-1010 can review a future result shape; none of these can be treated as clean executable write proof baseline evidence or as `memory write reliable` | Re-run fresh Git/runtime preflight and bind clean current branch/head/worktree facts before any future live write proof; use CM-0908 current-facts CLI, CM-0907 fixture CLI, and CM-1010 result boundary as review-only guards; require separate exact live-write approval and fail closed if dirty, stale, ambiguous, source-drifted, missing exact basis/seam/scope/boundary/result input, or claiming readiness/reliability | 2026-05-24 |
