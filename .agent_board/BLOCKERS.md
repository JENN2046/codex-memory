...
| CMB-0017 | open-status-synced | status-surface-not-ready-boundary | P6-docs-drift / P10-observability-admin | CM-1185 project status review sync | CM-1185 records current branch and validation evidence, but it does not run fresh mainline/strict gates, HTTP observe, provider validation, real memory tools, push-readiness, or any readiness/reliability closure. CM-1201 explicitly includes this blocker row in CM-1200/CM-1201 handoff, task, ledger, and validation scope so review/rollback consumers do not miss the blocker surface. | None for status sync. Separate exact scope and approval/evidence remain required before provider calls, real memory action, config/watchdog/startup change, public MCP expansion, push/PR/tag/release/deploy, or readiness/reliability claim. | 2026-05-31 |
