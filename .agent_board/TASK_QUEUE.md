...
| CM-0037 | 37 | in_progress | P1.8-board | A0 | `.agent_board/*.md` / `STATUS.md` | Board / STATUS closeout for Phase 1 | `git diff --check` / `npm test` / `npm run gate:mainline:strict` | `145/145` / gate all green | yes | Docs-only; local commit only; no push |
