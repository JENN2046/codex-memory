...
const CONTRACT_NAME = 'PlanPackExternalReviewEvidenceBundleApplicationGate';
const CONTRACT_MODE = 'local_phase9_phase10_external_review_bundle_application_gate_only';
const SCHEMA_VERSION = 1;

const ALLOWED_MODES = Object.freeze(['local-external-review-bundle-application-gate']);
const ALLOWED_DECISIONS = Object.freeze([
  'external_review_bundle_application_gate_ready_for_future_completion_audit_patch',
  'external_review_bundle_application_gate_blocked',
  'stop_l4'
]);
...
const REQUIRED_APPLICATION_GATE_FIELDS = Object.freeze([
  'gatePrepared',
  'categoryOnly',
  'lowDisclosureOnly',
...
const STOP_L4_TRUE_FIELDS = Object.freeze([
  ['applicationGate', 'reviewBundleAppliedToCompletionAudit'],
  ['applicationGate', 'completionAuditPatchApplied'],
  ['applicationGate', 'phase9CompletionClaimed'],
  ['applicationGate', 'phase10CompletionClaimed'],
  ['applicationGate', 'defaultRuntimeExpansionClaimed'],
  ['applicationGate', 'tagReleaseActionClaimed'],
  ['applicationGate', 'localContractsAllowedToSatisfyExternalReview']
]);
...
function collectUnexpectedFields(input) {
  ...
  return [
    ...
    ...collectUnexpectedKeys(input.applicationGate, REQUIRED_APPLICATION_GATE_FIELDS, 'applicationGate'),
    ...collectUnexpectedKeys(input.reviewEvidence, REQUIRED_REVIEW_EVIDENCE_FIELDS, 'reviewEvidence'),
...
function computeDecision(input) {
  ...
  const blockers = [
    ...
    ...missingTrueFields(input.applicationGate, [
      'gatePrepared',
      'categoryOnly',
      'lowDisclosureOnly',
      'reviewBundleApplicationRequired',
    ...
    ...invalidFalseFields(input.applicationGate, [
      'reviewBundleAppliedToCompletionAudit',
      'completionAuditPatchApplied',
      'phase9CompletionClaimed',
      'phase10CompletionClaimed',
    ...
    ...missingTrueFields(input.reviewEvidence, [
      'observationOrDogfoodReviewPassed',
      'externalReviewPassed'
    ], 'reviewEvidence'),
    ...invalidFalseFields(input.reviewEvidence, [
      'tagApprovalPacketPassed'
    ], 'reviewEvidence')
  ];
...
function evaluatePlanPackExternalReviewEvidenceBundleApplicationGate(input) {
  ...
  const missing = [
    ...
    ...missingFields(REQUIRED_APPLICATION_GATE_FIELDS, input.applicationGate, 'applicationGate'),
    ...missingFields(REQUIRED_REVIEW_EVIDENCE_FIELDS, input.reviewEvidence, 'reviewEvidence'),
  ...
  return {
    ...
    blockers: computed.blockers,
    applicationGateAccepted: accepted,
    requiredReviewEvidenceFields: [...REQUIRED_REVIEW_EVIDENCE_FIELDS],
    ...
    nextGate: accepted
      ...
      : 'repair_external_review_bundle_application_gate_evidence',
    reviewEvidenceAcceptedByThisContract: false,
    tagApprovalPacketAcceptedByThisContract: false,
    defaultRuntimeExpanded: false,
    tagCreated: false,
...
module.exports = {
  ...
  REQUIRED_APPLICATION_GATE_FIELDS,
