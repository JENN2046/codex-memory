...
const CONTRACT_NAME = 'Phase8NativeWriteProofReceiptBundleContract';
const CONTRACT_MODE = 'local_phase8_native_write_proof_receipt_bundle_contract_only';
const SCHEMA_VERSION = 1;

const ALLOWED_MODES = Object.freeze(['local-native-write-receipt-bundle-contract']);
const ALLOWED_DECISIONS = Object.freeze([
  'phase8_native_write_receipt_bundle_contract_ready_for_future_evidence',
  'phase8_native_write_receipt_bundle_contract_blocked_missing_receipts',
  'stop_l4'
]);
...
const REQUIRED_PREREQUISITE_FIELDS = Object.freeze([
  ...
  'phase8StillIncompleteBeforeBundle'
]);
...
const REQUIRED_RECEIPT_FIELDS = Object.freeze([
  ...
  'exactApprovalEnforcementReceipt',
  'nativeSideEffectReceipt',
  'realRootDurableWriteProofReceipt',
  'verifyWriteReceipt',
  'rollbackDrillReceipt',
  'failureRecoveryReceipt',
  'outputDisclosureBudgetReceipt',
  'auditReceipt'
]);

const REQUIRED_SEQUENCE_FIELDS = Object.freeze([
  'approvalBeforeNativeWrite',
  'realRootTargetBeforeNativeWrite',
  'prepareBeforeCommit',
  'commitBeforeVerify',
  'verifyBeforeRollbackDrill',
  'auditAfterNativeWrite',
  'rollbackAndFailureRecoverySeparated',
  'failureRecoveryCoversPartialWrite',
  'outputDisclosureCheckedBeforePatch'
]);
...
function computeDecision(input) {
  ...
  return {
    decision: 'phase8_native_write_receipt_bundle_contract_ready_for_future_evidence',
    blockers: []
  };
}
...
function evaluatePhase8NativeWriteProofReceiptBundleContract(input) {
  ...
  return {
    ...
    fullPlanPackCompleted: false,
    nextGate: accepted
      ? 'collect_or_review_future_exact_authorized_low_disclosure_phase8_receipts_without_completion_claim'
      : 'complete_missing_phase8_receipt_bundle_contract_fields',
