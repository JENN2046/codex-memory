...
async function main(argv = process.argv.slice(2)) {
  ...
  process.stdout.write(`${JSON.stringify({
    ...
    branchRefUpdated: result.branchRefUpdated,
    targetWorktreeIndexSynchronized: result.targetWorktreeIndexSynchronized,
    targetWorktreeFilesSynchronized: result.targetWorktreeFilesSynchronized,
    executionReceiptCreated: result.executionReceiptCreated,
    statusSyncPerformed: result.statusSyncPerformed,
