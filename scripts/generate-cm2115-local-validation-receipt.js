...
const DEFAULT_OUTPUT = path.join(
  ...
  'cm2115_local_validation_receipt.json'
);
...
function buildReceipt({ targetCommit, targetTree, commandResults }) {
  ...
  return {
    schemaVersion: 1,
    taskId: 'CM-2115',
    receiptType: 'canonical_full_plan_local_validation_receipt_v1',
...
function main() {
  ...
  commandResults.push(run(
    ...
    process.execPath,
    ['--test', 'tests/cm2115-canonical-full-plan-evidence-snapshot.test.js']
  ));
