...
Salvage/review note (2026-05-31): this checklist was recovered from
`salvage/review-p1-vcp-memory-core-100-roadmap` as a historical review artifact.
It is not a current production-readiness claim, release instruction, or
validation record. Use `STATUS.md`, `README.md`, and fresh Git/CI facts for
current state.
