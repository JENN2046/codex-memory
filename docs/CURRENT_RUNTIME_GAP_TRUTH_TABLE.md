...
14. Use `docs/CM-0565_FOUNDATION_RELIABILITY_EXACT_APPROVAL_BASELINE_REFRESH.md` as the current docs-only refresh of the CM-0562 exact-approval boundary to local baseline `77dec659d9a16b9795eab7fb1e9bf88798bcdc7c`. It does not execute true `record_memory` or true `search_memory`, and future execution remains blocked until live remote main is freshly verified and the user gives exact approval.
