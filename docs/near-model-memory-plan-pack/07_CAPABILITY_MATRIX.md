...
| Phase 8 receipt-backed evidence application | CM-2095 已应用 exact approval、native side effect、primary durable write、verify、disclosure、audit 及 bundle application；CM-2108 已另行应用 rollback drill evidence | 否 | 是 | failure recovery 仍未通过；provider/derived-index 不属于本次 Phase 8 completion 必需通过项；Phase 8 尚未完成 | 否 |
