...
| Phase 8 receipt-backed evidence application | CM-2095 已应用 exact approval、native side effect、primary durable write、verify、disclosure、audit 及 bundle application | 否 | 是 | rollback/failure/provider/derived-index 仍未通过；Phase 8 不完成 | 否 |
