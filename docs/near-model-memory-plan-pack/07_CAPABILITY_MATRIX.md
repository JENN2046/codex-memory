...
| Phase 8 receipt-backed evidence application | CM-2095/2108/2110 与 CM-2111 作为历史证据保留；CM-2112 重开当前 completion | 否 | 部分/历史 | 当前缺 VCPToolBox-owned runtime、实际 stdio→local-HTTP transport、稳定 target/store identity 三项 exact proof；`phase8Completed=false`、`needs_revalidation` | 否 |
