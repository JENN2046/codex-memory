...
| `npm run test:frozen-replay-e2e` | Opt-in, serial execution of the CM-2118, CM-2120, CM-2122, and CM-2126 frozen Git-replay executor suites; retains full one-shot/reentry coverage outside the default-safe latency budget | no |
