...
| `npm run test:frozen-replay-e2e` | Opt-in, serial execution of the CM-2118 and CM-2122 frozen Git-replay executor suites; retains full one-shot/reentry coverage outside the default-safe latency budget | no |
