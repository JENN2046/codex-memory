...
Salvage/review note (2026-05-31): this document was recovered from
`salvage/review-p1-vcp-memory-core-100-roadmap` as a historical strategy
artifact. It is not the current authority for branch state, readiness, release
status, or validation evidence. Use `STATUS.md`, `README.md`, and fresh Git/CI
