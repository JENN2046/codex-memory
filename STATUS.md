...
当前下一步是提交或稳定 CM-1218 evidence，然后准备一次 fresh `A5-GAP-6` aggregation refresh，把当前 approved evidence set 明确纳入聚合评估。不得把 CM-1210/CM-1211/CM-1212/CM-1213/CM-1214/CM-1215/CM-1216/CM-1217/CM-1218 解释为 runtime readiness、RC readiness、production readiness、cutover readiness、write reliability、recall reliability、governance readiness 或 `RC_READY`。
