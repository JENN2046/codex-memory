...
- 下一阶段建议完成 `P17.3-v8-diagnostic-cli-shape-gate` 的 diff/docs validation、guarded commit / safe-push，然后进入 `P17.4-v8-query-family-fixture-tests`。不得直接进入 runtime implementation、provider benchmark、V8 implementation、UI、migration/import-export apply、release candidate、tag 或 deploy。
