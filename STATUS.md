...
The canonical observer is not wired, the R5-H matrix is incomplete, R5-O
private exact-head runtime behavior is unverified, and fresh non-empty
task-context relevance is unproven.
