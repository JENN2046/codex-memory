...
- 下一阶段建议进入 `P22.2-release-candidate-gate-matrix-dry-run-plan`。仍不得安装 watchdog/startup task、改真实配置、跑 provider benchmark、real memory preview、import/export apply、migration、tag/release/deploy；P22 implementation 仍需显式 A5 approval。
