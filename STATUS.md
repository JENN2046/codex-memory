...
- P12.5 validate_memory two-phase audit protocol：将 audit preflight mitigation 升级为 pending/committed/cancelled two-phase audit；完整验证已通过，下一步需 guarded commit、safe-push readiness，通过后 push，再恢复 P14 后续节奏。
