...
43. 下一步建议：P13.6 import/export-safe JSON shape fixture tests。
44. provider/profile 相关动作继续保持按需触发，除非用户明确要求，不主动跑真实 provider 命令。
