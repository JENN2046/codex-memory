...
29. 下一步建议：P12.5 first runtime mutation tool planning/approval gate；runtime mutation 仍需显式批准。
30. provider/profile 相关动作继续保持按需触发，除非用户明确要求，不主动跑真实 provider 命令。
