...
24. 下一步建议：P11.10 guarded local commit、push readiness，然后进入 P12 controlled write tools planning。
25. provider/profile 相关动作继续保持按需触发，除非用户明确要求，不主动跑真实 provider 命令。
