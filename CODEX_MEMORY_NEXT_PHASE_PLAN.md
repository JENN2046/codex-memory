...
- Next recommended phase: `P34.3-validation-aggregator-review-surface-evidence-shape-candidate`. It should remain static report-shape evidence only if implemented.
