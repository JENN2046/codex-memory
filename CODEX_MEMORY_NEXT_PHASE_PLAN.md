...
- Next recommended phase: `P32.1-memory-governance-approval-packet-fixture-contract`. It may add a synthetic committed fixture/test for the P32 approval-packet shape. Durable mutation, public MCP expansion, real memory scans, provider/service/config actions, migration-import-export apply, backup/restore, package scripts, runner execution, and `push` remain separately authorized only.
