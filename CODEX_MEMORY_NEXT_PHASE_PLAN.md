...
- P22 release-candidate gate refresh approval request draft 已切换为 two-field target model [docs/P22_RELEASE_CANDIDATE_GATE_REFRESH_APPROVAL_REQUEST.md](/A:/codex-memory/docs/P22_RELEASE_CANDIDATE_GATE_REFRESH_APPROVAL_REQUEST.md)：`rc_target_commit=806cc847cb37a3e428099b45871a4f1a13c4fa6f` 是未来被测 RC 代码目标，`approval_request_commit=289cb6cd9bf8d0f1479c14c2370def78a7388acf` 是审批草案版本；不运行任何 gate。
