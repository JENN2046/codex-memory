...
- 下一步建议：wait for explicit new RC artifact creation approval targeting `7fd17de`; old `p22-rc-806cc847` remains superseded and must not be moved/reused; tag / release / deploy / provider / config / migration-import-export / public MCP expansion still requires separate explicit approval.
