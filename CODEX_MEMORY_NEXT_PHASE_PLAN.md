...
- Next recommended phase: P25.7 can integrate this fixture-only CLI evidence into the validation aggregator report shape, still without package scripts, real memory scans, runtime enforcement, provider calls, migration/import-export apply, durable writes, public MCP expansion, push, tag, release, or deploy.
