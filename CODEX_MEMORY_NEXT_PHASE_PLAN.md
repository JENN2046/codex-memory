...
- Next recommended phase: `P32.3-validation-aggregator-approval-packet-evidence-shape`. It may surface P32.2 helper capability as static ValidationAggregator report-shape evidence only. Durable mutation, public MCP expansion, real memory scans, provider/service/config actions, migration-import-export apply, backup/restore, package scripts, runner execution, and `push` remain separately authorized only.
