...
- Next recommended phase: `P31.1-memory-governance-fixture-contract-review`. It should review existing governance fixtures and identify the smallest missing fixture contract before any new runtime implementation. Real runtime enforcement, public MCP expansion, real memory scans, provider/service/config actions, migration-import-export apply, backup/restore, package scripts, runner execution, and `push` remain separately authorized only.
