...
- P22 release-candidate gate refresh approval request draft 已澄清 [docs/P22_RELEASE_CANDIDATE_GATE_REFRESH_APPROVAL_REQUEST.md](/A:/codex-memory/docs/P22_RELEASE_CANDIDATE_GATE_REFRESH_APPROVAL_REQUEST.md)，exact target commit 为当前远端 `main` HEAD `806cc847cb37a3e428099b45871a4f1a13c4fa6f`，包含 approval request 文档自身；不运行任何 gate。
