...
- Next recommended phase: `P30.1-final-rc-validation-matrix-runner-fixture-contract`. It may add a committed synthetic fixture and focused fixture test only. Real runtime enforcement, public MCP expansion, real memory scans, provider/service/config actions, migration/import-export apply, backup/restore, package scripts, and `push` remain separately authorized only.
