...
- 下一步建议：`request approval for new RC artifact targeting 7fd17de`; any RC artifact / tag / release / deploy / provider / config / migration-import-export / public MCP expansion still requires separate explicit approval.
