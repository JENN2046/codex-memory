...
- Next recommended phase: `P25.6-schema-compatibility-dry-run-cli-fixture-only`, limited to direct-node fixture-only CLI skeleton and targeted tests. It still does not authorize package scripts, live refresh, provider calls, migration/import-export apply, durable writes, runtime enforcement implementation, public MCP expansion, push, tag, release, or deploy.
