...
- Recommended next local phase: P66.27 ValidationAggregator unsupported source fail-closed closeout. 中文解释：下一步只能关闭 unsupported source fail-closed 这个本地证明切片，并选择下一个本地安全证据组；不能执行 runtime、gate、runner、service、provider、durable write 或声明 `RC_READY`。
