...
- Next recommended phase: `P31.4-memory-governance-aggregator-evidence-shape`. It may surface P31.3 helper capability as static ValidationAggregator report-shape evidence only. Real runtime enforcement, public MCP expansion, real memory scans, provider/service/config actions, migration-import-export apply, backup/restore, package scripts, runner execution, and `push` remain separately authorized only.
