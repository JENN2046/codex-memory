...
- Next recommended phase: P27.3 fixture-only approval-packet CLI implementation plan/review, separately scoped. Further `push` remains separately authorized only.
