...
test('phase f tagmemo semantic association fixture keeps a no-runtime boundary', () => {
  ...
  assert.deepEqual(fixture.publicMcpToolsFrozen, ['record_memory', 'search_memory', 'memory_overview', 'audit_memory', 'prepare_memory_context', 'propose_memory_delta', 'validate_memory', 'tombstone_memory', 'supersede_memory']);
