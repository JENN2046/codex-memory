...
test('CM-1408 fails closed when public MCP freeze evidence drifts', () => {
  const executionContextAuthorityConsistency = {
    ...
    publicTools: {
      expected: ['record_memory', 'search_memory', 'memory_overview', 'audit_memory', 'prepare_memory_context', 'propose_memory_delta', 'validate_memory', 'tombstone_memory', 'supersede_memory'],
