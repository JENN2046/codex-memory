...
test('CM-2110 application receipt rejects native actions or completion overclaim', () => {
  ...
  for (const mutate of [
    ...
    payload => { payload.sourceFailureRecoveryReceipt.tree = '0'.repeat(40); },
    payload => { payload.sourceFailureRecoveryReceipt.bytes += 1; },
    payload => { payload.sourceFailureRecoveryReceipt.productionReady = true; },
