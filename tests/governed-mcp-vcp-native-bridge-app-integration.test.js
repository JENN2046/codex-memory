...
function nativeRuntimeReceiptForTool(toolName) {
  ...
  return {
    ...
    durableWriteScope: writePerformed ? 'primary_memory_write' : 'isolated_derived_index',
    isolatedRuntimeStoreUsed: !writePerformed,
    primaryMemoryStoreWritePerformed: writePerformed,
    derivedIndexWritePerformed: !writePerformed,
    derivedRuntimeMutationPolicy: writePerformed
      ? 'disabled'
      : 'isolated_derived_runtime_mutation_v1',
    derivedRuntimeMutationAccountingMode: writePerformed
      ? 'not_applicable'
      : 'lifecycle_event_v1',
    derivedRuntimeMutationAuthorized: !writePerformed,
    derivedRuntimeMutationAccountingFinal: false,
    derivedRuntimeMutationBackgroundTasksDrained: false,
    derivedRuntimeMutationCumulativeCount: writePerformed ? 0 : 1,
    derivedRuntimeMutationReceiptDelta: writePerformed ? 0 : 1,
    derivedRuntimeMutationActiveCount: 0,
    derivedRuntimeMutationCompletedCount: writePerformed ? 0 : 1,
    derivedRuntimeMutationFailedCount: 0,
    derivedRuntimeMutationTriggerCategories: writePerformed ? [] : ['startup'],
